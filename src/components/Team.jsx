        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-10 mx-auto max-w-screen-lg">
                <div className="flex flex-col text-center w-full mb-20">
                    <h1 className="max-w-2xl mx-auto  text-4xl font-medium tracking-tight leading-none md:text-5xl xl:text-6xl text-gray-900 ">Our<span className='text-[#4d55bb] font-extrabold'> Team</span></h1>
                </div>
