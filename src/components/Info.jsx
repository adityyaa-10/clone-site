    ...
    <section className="bg-white mt-0 md:mt-10 ">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            ...
            <div className="ml-auto place-self-center lg:col-span-7 ">
                <h1 className="max-w-2xl mb-4 text-4xl font-light tracking-tight leading-none md:text-5xl xl:text-6xl text-center sm:text-left ">What is <span className='text-[#4d55bb] font-bold'>E-Cell ?</span></h1>
