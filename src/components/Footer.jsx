            ...
            <footer aria-label="Site Footer" class="bg-white">
                <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <div class="flex justify-center text-[#4d55bb] sm:justify-start">
                                <h1 className=' text-3xl'>SUBSCRIBE TO E-CELL</h1>
                            </div>

                            <p
                                class="mx-auto sm:mt-6 sm:mb-6 mt-2 mb-2 text-center leading-relaxed text-gray-700 font-medium text-lg sm:mx-0 sm:max-w-xl sm:text-left"
                            >
                                ...
                                <ul class="mt-8 space-y-4 text-sm">
                                    <li>
                                        ...
                                        >
                                            ...
                                            <span class="text-gray-700">ecell@kiet.edu</span>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        >
                                            ...
                                            <span class="text-gray-700">+91 94557 19685</span>
                                        </a>
                                    </li>
                            ...
                            <div class="text-center sm:text-left">
                                ...
                                <nav aria-label="Footer Services Nav" class="mt-8">
                                    <ul class="space-y-4 text-sm">
                                        <li>
                                            <a
                                                class="text-gray-700 transition hover:text-[#4d55bb]"
                                                href="/"
                                            >
                                                Our Blogs
                                            </a>
                                ...
                                <nav aria-label="Footer Helpful Nav" class="mt-8">
                                    <ul class="space-y-4 text-sm">
                                        ...
                                        <li>
                                            ...
                                            >
                                                <span
                                                    class="text-gray-700 transition group-hover:text-[#4d55bb]"
                                                >
                                                    Past Speakers
                                                </span>
